...
Użycie:
    python scraper_sts.py              # pobierz kupony i analizuj AI
    python scraper_sts.py --brak-ai    # tylko pobierz, bez AI
    python scraper_sts.py --top 20     # top 20 typerów (domyślnie 50)
"""
...
def analizuj_kupony_ai(kupony: list) -> list:
    ...
    try:
        ...
        print("[AI] Brak ai_client.py — pomijam analizę AI")
        return kupony
...
{{
  ...
  "komentarz": "Kupon zawiera..."
        ...
        try:
            ...
            wynik = {"nick": nick, "ocena": "BŁĄD", "komentarz": str(e)}
...
def main():
    ...
    if not brak_ai:
        ...
        for w in wyniki_ai:
            ocena = w.get("ocena","?")
            kolor = "🟢" if ocena == "DOBRY" else "🟡" if ocena == "RYZYKOWNY" else "⚪"
